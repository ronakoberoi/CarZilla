...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      <Title title="Admin Dashboard" subTitle="Monitor overall platform performance including total cars, bookings, revenue, and recent activitties" />
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        {/* Recent Booking */}
        <div className='p-4 md:p6 border border-borderColor rounded-md max-w-lg w-full'>
